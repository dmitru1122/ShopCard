...
class AllElement extends React.Component {
  ...
  render() {
    ...
    if (this.state.thisData == null) {
      return (
        <div onClick={() => console.log(this.state.thisData)}>Wait please</div>
      );
    } else {
      return (
        <>
...
function ForJeans() {
  return <AllElement category="Jeans" />;
}
function ForJacket() {
  return <AllElement category="Jacket" />;
}
function ForShirt() {
  return <AllElement category="Shirt" />;
}
function ForShoes() {
  return <AllElement category="Shoes" />;
}
function forDresses() {
  return <AllElement category="Dresses" />;
}
function ForAll() {
  return <AllElement category="All" />;
}
