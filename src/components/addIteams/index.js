...
class AddIteam extends React.Component {
    ...
    render() {
        ...
        const forJeans = ( <
            > { colorFilter } { fitFilter } { waistFilter } { sizeFilter } <
            />
        );
        const forShirt = ( <
        ...
        return ( <
            ...
            option value = { categoryName.jeans } > { categoryName.jeans } <
            /option> <
            option value = { categoryName.dresses } > { categoryName.dresses } <
            /option> <
            option value = { categoryName.shirt } > { categoryName.shirt } <
            /option> <
            option value = { categoryName.shoes } > { categoryName.shoes } <
            /option> <
            option value = { categoryName.jacket } > { categoryName.jacket } <
            /option> <
            /select> <
            /label> <
            /div> { build } <
            ...
            <
            button onClick = {
                () => this.sendFetch(this.state) } > Send < /button> <
            /div> <
            /div> <
            /div> <
            /div>
