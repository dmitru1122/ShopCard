...
class HeaderLeftPart extends React.Component {
  ...
  render() {
    ...
    const show = (
      <img className="icon-show-hide" src={IconToShow} title="show list" />
    );
    const hide = (
      <img className="icon-show-hide" src={IconToHide} title="show list" />
    );
    ...
    return (
      <div className="header-left-part-conteiner">
        <div
          ...
          onClick={() => this.handleClick("manVisibility")}
        >
          For Men {ImageMan} <div>{checkMan}</div>
        </div>

        <div
          className="cursor-pointer"
          onClick={() => this.handleClick("womanVisibility")}
        >
          For Women {ImageWoman}
          <div>{checkWoman}</div>
        </div>
...
function HeaderLogo() {
  return (
    <div
      className="header-logo-conteiner text1-7 to-main-page"
      title="To main page"
    >
      <Link to="/">
